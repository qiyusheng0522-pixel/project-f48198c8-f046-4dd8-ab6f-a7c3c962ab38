...
const groups = [
  {
    title: "个人资料",
    items: [
      { icon: Edit3, label: "基本信息", desc: "姓名 / 工号 / 资质" },
      { icon: Award, label: "我的证书", desc: "健康管理师中级" },
      { icon: FileText, label: "服务记录", desc: "查看历史服务" },
    ],
  },
  {
    title: "设置",
    items: [
      { icon: Bell, label: "消息通知", desc: "已开启" },
      { icon: Shield, label: "隐私安全", desc: "" },
      { icon: Settings, label: "通用设置", desc: "" },
